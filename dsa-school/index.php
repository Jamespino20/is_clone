...
<body class="bg-light">
  <div class="container-fluid min-vh-100 d-flex flex-column justify-content-between p-0">
    ...
    <div class="row flex-grow-1 g-0">
      ...
      <!-- Right (login box) -->
      <div class="col-lg-6 d-flex align-items-center justify-content-center bg-white p-0 login-mobile-right">
        <div class="w-100" style="max-width: 420px; margin: 0 auto;">
          ...
          <form id="loginForm" class="shadow rounded p-4 bg-light">
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
              <a href="forgot.php" id="forgot-pass" class="small mt-1">Forgot your password?</a>
...
<form id="registerForm" autocomplete="off">
  ...
  <div class="mb-2">
    <input type="email" placeholder="Email (@slssr.edu.ph or @gmail.com)" name="email" required>
  </div>
  <div class="mb-2">
  ...
  <div class="status mt-3" id="regStatus"></div>
</form>
      </div>
...
<!-- 2FA Modal -->
<!-- Two-Factor Authentication Modal or Page -->
