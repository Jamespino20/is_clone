...
<body>
    <?php
        ...
        $subtitle = 'Audit Logs'; $assetPrefix = '..'; include __DIR__ . '/../partials/header.php';
    ?>

    <main class="container">
        <section class="card">
            <h2>System Audit Logs</h2>
            <p>View detailed logs of all system activities and user actions. This is an alias to the main audit logs page.</p>
